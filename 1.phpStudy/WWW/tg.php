    ...
    <div class="jietu_pic">
        ...
        <div class="main">
            ...
            <div class="role">
                <div class="t"></div>
                <ul class="r-hd cls">
                    <li class="warrior cur">战士</li>
                    <li class="magic">法师</li>
                    <li class="daoshi">道士</li>
                </ul>
                <div class="role-con" id="rolePanel">
                    ...
                    <div class="role-detail curElem" id="r1" style="display: block">
                        <div class="r-desc" data-left="-468">
                            ...
                            <p class="description">
                                <b>职业介绍：</b>
                                <br/> 超强爆发力和生命力，传承“龙卫圣战”的武技，烈火剑法和开天斩将力量推至极致瞬间造成巨大伤害，而剑气绝学刺杀剑术能够无视目标的防御力造成真实伤害。攻击手段主要为近身劈砍，用自身强大的体魄和敌人硬碰硬。
                            </p>
                    ...
                    <div class="role-detail" id="r2">
                        <div class="r-desc" data-left="-468">
                            ...
                            <p class="description">
                                <b>职业介绍：</b>
                                <br/>战场舞者，继承“龙卫法神”秘术，强大的单体法术雷电术，针对其相对虚弱的体制又拥有魔法盾技能抵挡伤害，大范围群体攻击的王者，不论是大范围刷怪还是团战竞技都是可怕的火力输出，走位意识强大的法师甚至能快速横推整张地图。</p>
                            <a class="readmore">了解职业<i></i></a>
                        </div>
                        <div class="r-per" data-right="-468">
                    ...
                    <div class="role-detail" id="r3">
                        <div class="r-desc" data-left="-468">
                            ...
                            <p class="description">
                                <b>职业介绍：</b>
                                <br/>   协调自然之力的使者，师从“龙卫天尊”道观，虽无强大的爆发或过多大范围杀伤能力，但作为玛法世界唯一能和其他圣灵沟通的职业，他们能够从幽冥和天界召唤仆从助战，施毒术更加强了其单刷Boss的能力，简直是最难缠的角色，攻守兼备。</p>
                            <a class="readmore">了解职业<i></i></a>
                        </div>
                        <div class="r-per" data-right="-468">
