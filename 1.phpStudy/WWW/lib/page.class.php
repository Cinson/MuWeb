...
class page {
	...
	*/
	function page($array){
	   ...
	   if((!is_int($total))||($total<0))$this->error(__FUNCTION__,$total.' '.$total.'  is not a positive integer1!');
	   if((!is_int($perpage))||($perpage<=0))$this->error(__FUNCTION__,$perpage.' is not a positive integer2!');
	...
	*/
	function next_page($style=''){
	   if($this->nowindex<$this->totalpage){
		return "<li class='pgdn'>".$this->_get_link($this->_get_url($this->nowindex+1),$this->next_page,$style)."</li>";
	   }
