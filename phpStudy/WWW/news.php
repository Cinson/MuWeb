...
<i class="icon"></i></a>
    ...
    <a target="_blank" href="../server_list.php?gid=1" class="all-server" rel="nofollow"></a>
        ...
        <div class="main">
            <div class="content">
                <div class="article-top"> <p>新闻公告</p>
                    <div class="bread-nav">当前位置：<a href="/">传奇霸业</a> &gt; <a>新闻公告</a></div>
                </div>
 <div class="article-main"><?php
                        //新闻内面
                        $id = htmlspecialchars($_GET['id']);
                        $sql="select * from $database.news where id = $id ";
                        ...
                        <div class="article-detail">
                            作者：<?php echo $site_name ?>&nbsp;&nbsp;&nbsp;时间：<?php echo $row['time'] ?>
                        </div>
